            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-striped" id="example2">
                    ...
                    <c:forEach var="product" items="${productDao.selectAll()}">
                        <tr class="hide">
                            <td name="productId" id="productId2"><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong id="product_id">${product.productId}</strong></td>
                            <td>
                        ...
                        <div class="table-responsive text-nowrap">
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach var="importDetail" items="${importedItem.getImportDetailList()}">
                                   <td><p name="productId" id="productId" class="form-control form-control-sm"> ${importDetail.product.productId}  </p></td>
                                    <td><span name="product_name" class="titleProduct"> ${importDetail.product.product_name} </span></td>
                                    <td><input name="numberOfWarehouses" id="numberOfWarehouses" type="number" class="input-value form-control form-control-sm" value="${importDetail.numberOfWarehouses}" min="1" onclick="inputchange()" oninput="calculateTotal()" ></td>
                                    <td><input name="unitPrice" type="number" class="input-value form-control form-control-sm"  onclick="inputchange()" oninput="calculateTotal()" value="${importDetail.unitPrice}"></td>
                                    <td><input name="totalPrice" type="number" id="totalPrice" value="${importDetail.totalPrice}" class="total-price form-control form-control-sm" readonly></td>
                            ...
                            <div class="price-total">
                                <p style="text-align: right; font-weight: bold; padding: 15px 20px;">
                                    Tổng tiền: <span>${importedItem.getTotalPrice()}</span><sup>đ</sup>
                                </p>
                            </div>

                            <div class="checkout__input">
                                <label for="ncc">Nhà cung cấp</label>
                                <input type="text" id="ncc" name="ncc" value="${importedItem.supplier}" class="form-control">
                            </div>

                            <div class="checkout__input">
                                <label for="note">Ghi chú</label>
                                <input type="text" id="note" name="note" value="${importedItem.note}" class="form-control">
                            </div>
                            <input type="hidden" id="importId" name="importId" value="${importId}"  />

                            <input type="submit" value="Sửa đơn hàng" class="btn btn-primary btn-light-purple">
...
<script>
    ...
    document.querySelector('input[type="submit"]').addEventListener('click', function(event) {
        ...
        xhr.open('POST', '/ChangeImport2', true);
