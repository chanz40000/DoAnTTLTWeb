                ...
                <c:choose>
                    ...
                    <c:when test="${admin.role == 4}">
                        <div class="container-xxl flex-grow-1 container-p-y">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <form action="./OpenAndBlockAccount" method="GET">
                                                                    ...
                                                                    <input type="hidden" name="action" value="lockAdmin" />
                            ...
                            <div>
                                <div class="card">
                                    <h5 class="card-header">Danh sách tài khoản admin bị khóa</h5>
                                    <div class="table-responsive text-nowrap">
                                        <table class="table">
                                            <thead>
                                            <tr>
                                            ...
                                            <tbody class="table-border-bottom-0">
                                            <c:forEach var="user" items="${userDao.selectAdminBlock()}">
                                                <tr>
                                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>${user.username}</strong></td>
                                                    <td>${user.name}</td>
                                                    <td>${user.email}</td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <form action="./OpenAndBlockAccount" method="GET">
                                                                    <input type="hidden" name="userId" value="${user.userId}" />
                                                                    <input type="hidden" name="action" value="unLockAdmin" />
                                                                    <button type="submit" class="dropdown-item">
                    ...
                    <c:otherwise>
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4>Bạn không có quyền truy cập vào đây!</h4>
                        </div>
                    </c:otherwise>
                </c:choose>
