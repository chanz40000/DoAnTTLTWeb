        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper" id="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y" id="content-big-section">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Đơn hàng /</span>Lịch sử cập nhật trạng thái đơn hàng</h4>

                    <!-- Basic Bootstrap Table -->
                    <div class="card">
                        <h5 class="card-header">Lịch sử cập nhật trạng thái đơn hàng</h5>
                        <div class="table-responsive text-nowrap">
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <c:forEach var="history" items="${orderHistoryDAO.selectAll()}">
                                    <%-- <li><a href="#">${order.categoryName}</a></li>--%>
                                    <tr>
                                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>${history.orderHistoryId}</strong></td>
                                        <td>${history.order.orderId}</td>

                                        <td><span class="badge bg-label-primary me-1">${history.statusOrder.statusName}</span></td>
                                        <td>
                                            <c:if test="${not empty history.user}">
                                                <c:choose>
                                                    <c:when test="${history.user.role == 2}">
                                                        ID User: ${history.user.userId}
                                                    </c:when>
                                                    <c:otherwise>
                                                        ID Admin: ${history.user.userId}
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:if>
                                        </td>
