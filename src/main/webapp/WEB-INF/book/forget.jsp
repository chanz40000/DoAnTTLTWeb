        ...
        <div class="signin-content">
            ...
            <div class="signin-form">
                ...
                <form action="ForgotPassword" method="post" class="register-form" id="login-form">
                    <p style="color: #a71d2a; font-weight: bold">Thực hiện việc thay đổi mật khẩu theo 3 bước sau. Điều này sẽ giúp bạn bảo mật an toàn mật
                        khẩu</p>
                    <ol class="list-unstyled">
                        <li><span style="color: black; font-weight: bold">1. </span> Nhập địa chỉ email của bạn</li>
                        <li><span style="color: black; font-weight: bold">2. </span>Hệ thống của chúng tôi sẽ gửi mã OTP tới email của bạn</li>
                        <li><span style="color: black; font-weight: bold">3. </span>Nhập mã OTP bạn nhận được</li>
                    </ol>
                    <div class="form-group">
                        <label for="emailForget"><i class="fa fa-envelope"></i></label>
                        <input type="email" name="emailForget" id="emailForget" placeholder="Nhập email của bạn" required/>
                    </div>
...
<%--                    </div>--%>
                    <div class="form-group form-button">
                        <input type="submit" name="signin" id="signin" class="form-submit" value="Gửi mã OTP"/>
                        <button onclick="event.preventDefault(); window.location.href='./Login';" class="btn btn-success">
                            Quay lại
                        </button>
