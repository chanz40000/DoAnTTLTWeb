                    ...
                    <c:choose>
                        <c:when test="${not empty ratings}">
                            <table id="example">
                                ...
                                <tbody>
                                <c:forEach var="ra" items="${ratings}">
                                    <tr>
                                        <td class="shoping__cart__item">
                                            <img src="/image/${ra.product.image}" alt="" width="50px" height="70px">

                                            <h5>${ra.product.product_name}</h5>
                                        </td>
                                        <td >
                                            <fmt:formatNumber value="${ra.ratingstar}" type="number" pattern="#"/>
                                        </td>
                                        <td>
                                                ${ra.ratingtext}
                                        </td>
                                        <td >
                                                ${ra.getFormattedDateRating()}
                                        </td>
