...
<nav>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            ...
            <c:set var="total" value="${sessionScope.cart.calculateTotal()}"/>
            <c:set var="price" value="${FormatCurrency.formatCurrency(total)}"/>
            <div class="header__cart__price">item: <span>${empty sessionScope.cart ? '0' : price}</span></div>
        </div>
